...
REM تحديث المكتبات لـ v5.3.0 مع حل WebSocket
echo 📦 تحديث venom-bot إلى v5.3.0 مع حل WebSocket...
npm install venom-bot@5.3.0 puppeteer@19.11.1 ws@8.14.2 --save
